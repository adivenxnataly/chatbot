(function () {
    ...
    app.querySelector(".join-screen #join-user").addEventListener("click", function () {
        ...
        setTimeout(() => {
            ...
            // Jalankan animasi untuk elemen di halaman chatbot
            startTitleAnimation();
            startApiAnimation();
            startStatusLogoAnimation(); // Jalankan animasi status-logo
        }, 500);
    });
    ...
    function startStatusLogoAnimation() {
        ...
        if (statusLogo) {
            // Reset status-logo ke keadaan default
            statusLogo.classList.remove("show", "active", "error");
            statusLogo.style.opacity = "0"; // Pastikan opacity di-reset

            // Jalankan animasi setelah 7 detik
            setTimeout(() => {
    ...
    app.querySelector(".chat-screen #exit-chat").addEventListener("click", function () {
        ...
        if (confirmExit) {
            ...
            setTimeout(() => {
                ...
                // Hentikan dan reset animasi status-logo
                const statusLogo = document.querySelector(".status-logo");
                if (statusLogo) {
                    statusLogo.classList.remove("show", "active", "error");
                    statusLogo.style.opacity = "0"; // Reset opacity
                }
            }, 500);
        }
    });
    ...
    app.querySelector(".chat-screen #send-message").addEventListener("click", function () {
        ...
        const statusLogo = document.querySelector(".status-logo");
        if (statusLogo) {
            // Reset class ke keadaan default
    ...
    socket.on("chatbot", function (message) {
        ...
        if (statusLogo) {
            ...
            // Ubah warna menjadi merah jika respon adalah error
